...
public class LoadingPanel extends JComponent implements MouseListener {  
    ...
    //��������ʾ����
    public static String progressTextString = "盛世齐天服务指导平台"
    		+ "正在安全退出中，请稍后！";
...
//                int channel = 255 - 128 / (i + 1);  
//                g2.setColor(new Color(channel, channel, channel, alphaLevel));  
            	if(i == 0) {
            		g2.setColor(progressCommonBgColor);  
            	} else {
            		g2.setColor(progressSelectBgColor);  
            	}
